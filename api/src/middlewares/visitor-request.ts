...
/** Visitor cookie lifetime — 30 days. */
 ...
 * cookies use the `X-Visitor-Session` header fallback instead — see ADR-0012.
 * (#75)
 ...
 * is the same signed cookie value; the widget holds it in its own storage
 * (#75). See ADR-0012.
 */
